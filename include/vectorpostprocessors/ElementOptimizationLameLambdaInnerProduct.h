...
class ElementOptimizationLameLambdaInnerProduct : public ElementOptimizationFunctionInnerProduct
{
public:
  static InputParameters validParams();

  ElementOptimizationLameLambdaInnerProduct(const InputParameters & parameters);
